@extends('luminous::layout')

@section('title', 'Luminous Lab- web Installer')
...
@section('content')
    <div class="section-wrap-body">
        ...
        <div class="single-section">
            <h4 class="section-title">Please make sure you have set the Writable permission on the following
                folders/files :</h4>
        ...
        <div>
            <div class="row">
                <div class="col-6">
                    <a href="{{ route('Luminous::pre.install') }}" class="primary-btn">Close</a>
                </div>
                <div class="col-6">
                    <form action="{{ route('Luminous::server.validation') }}" method="POST">
                        @csrf
                        ...
                        <input type="hidden" name="env"
                               value="{{ File::exists(base_path('.env')) && $env_value == 1 ? 1 : 0 }}">
