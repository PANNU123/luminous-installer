...
@section('content')
    <div class="section-wrap-body">
        ...
        <div class="primary-form">
            <form action="{{ route('Luminous::final') }}" method="POST">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="AppName" name="app_name" value="{{ $_ENV['APP_NAME'] }}" placeholder="Luminous Installer" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
